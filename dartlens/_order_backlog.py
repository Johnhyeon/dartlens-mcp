...
# 배열 순서가 곧 우선순위다. 'USD' 를 먼저 보면 '천USD' 가 '달러'로 읽힌다 -
# 실측(일진전기 2023 사업보고서 20240313001767)의 '(단위 : 천USD )' 표가
# 1,297,775 달러로 나갔다. 실제는 천달러, 즉 1,000배다. 긴 표기부터 본다.
_FOREIGN_UNITS = (
    ("백만달러", "백만달러"), ("백만불", "백만달러"), ("백만US$", "백만달러"),
    ("백만USD", "백만달러"),
    ("천달러", "천달러"), ("천불", "천달러"), ("천USD", "천달러"), ("천US$", "천달러"),
    ("USD", "달러"), ("달러", "달러"), ("US$", "달러"),
)
